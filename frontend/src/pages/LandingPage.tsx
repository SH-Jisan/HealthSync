...
export default function LandingPage() {
    ...
    return (
        <div style={{ fontFamily: "'Poppins', sans-serif", backgroundColor: 'var(--background)', minHeight: '100vh' }}>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                    ...
                    <button
                        ...
                        style={{
                            ...
                            padding: '10px 24px', borderRadius: '50px', fontWeight: 'bold', cursor: 'pointer',
            ...
            {/* Hero Section */}
            <header style={{ textAlign: 'center', padding: '4rem 1rem', maxWidth: '800px', margin: '0 auto' }}>
                <h1 style={{ fontSize: '3.5rem', lineHeight: '1.2', marginBottom: '1.5rem', color: 'var(--text-primary)' }}>
                    Your Personal <span style={{ color: 'var(--primary)' }}>AI Health</span> Assistant
                </h1>
                ...
                <button
                    ...
                    style={{
                        ...
                        padding: '16px 40px', borderRadius: '50px', fontSize: '1.1rem', fontWeight: 'bold', cursor: 'pointer',
            ...
            {/* Features Grid */}
            <section style={{ maxWidth: '1000px', margin: '2rem auto', padding: '0 1rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>

                <FeatureCard
                    icon={<Brain size={32} color="#7E22CE" />}
                    title="AI Doctor"
                    desc="Instant symptom analysis and triage using advanced Gemini AI."
                    bg="#F3E8FF"
                />
                ...
                <FeatureCard
                    ...
                    desc="Keep track of your history. Upload reports and let AI organize them."
                    bg="#D1FAE5"
                />
                ...
                <FeatureCard
                    ...
                    title="Blood Bank"
                    desc="Real-time blood requests and donor connecting system."
                    bg="#FEE2E2"
                />
            ...
            {/* Footer */}
            <footer style={{ textAlign: 'center', padding: '3rem', marginTop: '3rem', borderTop: '1px solid var(--border)' }}>
                <p style={{ color: 'var(--text-secondary)' }}>© 2024 HealthSync Inc. Better Healthcare for Everyone.</p>
            </footer>
        </div>
    );
}
...
function FeatureCard({ icon, title, desc, bg }: { icon: React.ReactNode, title: string, desc: string, bg: string }) {
    return (
        <div style={{
            ...
            <div style={{ width: '60px', height: '60px', borderRadius: '50%', background: bg, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1rem' }}>
                {icon}
            </div>
